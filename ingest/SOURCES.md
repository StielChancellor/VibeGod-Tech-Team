...
All scanned read-only (no install scripts run). See `reports/SCAN-SUMMARY.md` + `reports/impeccable.md`.
Attribution is preserved on ingest (see `ATTRIBUTION.md`).

| # | Source | URL | Role in plugin | Scan |
|---|--------|-----|----------------|------|
