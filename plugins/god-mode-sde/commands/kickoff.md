...
◆ Gate: Once the dump feels complete and the objective is captured, stop. Summarize the scratchpad and the stated objective, confirm with the user, and point them to `/prd` to begin Stage 1.
