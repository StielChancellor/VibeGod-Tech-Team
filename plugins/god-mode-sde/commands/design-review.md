...
This is an **architecture review gate** — run it before code is written (typically after Stage 4 module map / before Stage 5 build plan). Following top-tier SDE practice: design docs get a design review before implementation.
