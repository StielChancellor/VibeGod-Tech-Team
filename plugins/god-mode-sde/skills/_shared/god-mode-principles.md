# God-Mode SDE — Operating Principles

The non-negotiable principles every God-Mode SDE skill and agent follows. Loaded by the
`sde-orchestrator` and referenced by every role agent. When any instruction conflicts, use
this priority order:

> **User instructions > God-Mode skills > default model behavior.**
