...
1. Render the page at each breakpoint in the matrix (320→1920) using available tooling: a Preview/Chrome
   MCP, or a dev server + headless screenshots (e.g. `npx playwright`), or the project's run/preview skill.
