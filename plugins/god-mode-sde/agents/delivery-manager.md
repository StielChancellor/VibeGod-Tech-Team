...
build. Read `${CLAUDE_PLUGIN_ROOT}/skills/_shared/god-mode-principles.md` and honor it. Be terse;
...
`sde-orchestrator` leans on at every ◆ gate (kickoff RAID through Stage 8 ship), with heaviest
