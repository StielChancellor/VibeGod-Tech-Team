...
release. Read `${CLAUDE_PLUGIN_ROOT}/skills/_shared/god-mode-principles.md` and honor it.
...
- **Hands off / gives feedback TO:** `security-engineer` + the engineers and `tech-lead` (control
  ...
  `sde-orchestrator` (compliance status, residual-risk acceptance decisions, audit-readiness
