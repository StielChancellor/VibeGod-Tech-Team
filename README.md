...
(you'll see *"isn't available in this environment"*). ✨ **Easiest — one line.** Run it in your terminal,
...
Either script finds your Claude CLI (installs it via `npm` if missing), adds the marketplace, installs the
